    ...
    switch ($_REQUEST['action']) {
      ...
      case 'lista_unidades':
		...
		unset($where);
			...
			$query="SELECT  centro.id_centro, centro.nombre_centro,
							areas.nombre_area, unidad.id_unidad, unidad.nombre_unidad,
							areas.id_centro
					FROM	$db.areas 
					INNER JOIN  centro ON centro.id_centro = areas.id_centro 
					INNER JOIN  unidad ON areas.id_area = unidad.id_area 
					$where 
					";
			// echo $query; exit;	
