...
$db = new EyeMySQLAdap('localhost', 'root', 'sena', 'biosoft');

// Load the datagrid class
$x = new EyeDataGrid($db);

// Set the query
$x->setQuery("*", "tipo_materia_prima_e_insumos", 'Id');
...
<body>
<h1 align='center'>CONSULTA TIPO DE MATERIA PRIMA E INSUMOS</h1><br><br><br>
<?php
// Print the table
