  ...
  <script type="text/javascript">
    $(document).ready(function () {	
	   ...
	   $('#TableContainer').jtable({
        title: 'LISTA FICHA REGISTRADAS',	//Se cambia según el formualrio
        sorting: true,
        defaultSorting: 'ficha.codigo_ficha ASC',	//cambio
        paging: true,
        ...
        actions: {
          ...
          listAction: '../controlador/ctrl_grilla_ficha.php?action=lista_ficha',
          // deleteAction: '../controlador/ctrl_grilla_areas.php?action=elimina_usuario'
        },
		toolbar: {
		items:[{
				tooltip: 	'Haga click aqui para agregar una nueva ficha',
				icon: 		'../../herramientas/jtable/themes/lightcolor/check.png',
				text: 		'Agregar Nueva ficha',
				click: function () {
				opcion_usuario('registra_ficha', '', '0', '');
				}
			}]
		},
		fields: {
         ...
         nombre_centro: {
			...
			btnEditar: {
				...
				display: function (fichaData) {
					...
					$img.click(function () {
						opcion_usuario('actualizar_ficha', fichaData.record.codigo_ficha, '0', '');
					});
					return $img;
				}
			}
	...
	function opcion_usuario(action, codigo_ficha, tipo, id_entidad)
		{
			ventana1('frm_ficha.php?action='+action+'&id_usu='+codigo_ficha+'&tipo='+tipo+'&id_entidad='+id_entidad, '700', '360', 'Actualizar Datos de ficha');
		}
	function opcion_usuario(action, id_programa, tipo, id_entidad)
		{
			ventana1('frm_ficha.php?action='+action+'&id_usu='+id_programa+'&tipo='+tipo+'&id_entidad='+id_entidad, '700', '360', 'Actualizar Datos de ficha');
		}
...
function ventana1(strURL, strWidth, strHeigth, strTitle){
	...
	<div id='div_opciones' style="text-align:center;margin-left:auto; margin-right:auto;width:100%;" >
		<table  width='50%' align='center' >
			<tr><td colspan='2' >LISTA DE FICHAS INGRESADAS</td></tr>
			<tr>
				<td >CENTROS</td>
				<td>AREAS</td>
			</tr>
