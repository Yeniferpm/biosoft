...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function () {	
	   ...
	   $('#TableContainer').jtable({
        ...
        actions: {
          ...
          listAction: '../controlador/ctrl_grilla_azas_insumos.php?action=lista_azas',
         ...
         nombre_area: {
			...
			btnEditar: {
				...
				display: function (azasData) {
					...
					$img.click(function () {
						opcion_usuario('actualizar_unidad', azasData.record.azas_ins, '0', '');
					});
					return $img;
				}
			}
	...
	function opcion_usuario(action, id_azas_ins, tipo, id_entidad)
		{
			ventana1('frm_azas_insumos.php?action='+action+'&id_usu='+id_azas_ins+'&tipo='+tipo+'&id_entidad='+id_entidad, '700', '360', 'Actualizar Datos de unidad');
		}	
