    ...
    switch ($_REQUEST['action']) {
      ...
      case 'lista_unidades':
		...
		unset($where);
			...
			$query="SELECT	  tipo_ingreso.id_tipo_ingreso, tipo_ingreso.nombre_tipo_ingreso,
							  materia_prima_e_insumos.id_tipo_ingreso,
							  tipo_materia_prima_e_insumos.id_azas_ins,
							  tipo_materia_prima_e_insumos.azas_ins,
							  materia_prima_e_insumos.id_azas_ins, unidad.id_unidad,
							  unidad.nombre_unidad, materia_prima_e_insumos.id_unidad,
							  materia_prima_e_insumos.fecha_ingreso,
							  materia_prima_e_insumos.hora_ingreso,
							  materia_prima_e_insumos.cantidad,
							  materia_prima_e_insumos.quien_entrega,
							  materia_prima_e_insumos.proveedor,
							  materia_prima_e_insumos.id_materia_prima_insumos,
							  materia_prima_e_insumos.observaciones, registro_usuario.id_usuario,
							  registro_usuario.n_documento, materia_prima_e_insumos.id_usuario,
							  unidad_de_medida.id_unidad_medida, unidad_de_medida.unidad_medida
					FROM  	  $db.tipo_ingreso 
					INNER JOIN  materia_prima_e_insumos ON tipo_ingreso.id_tipo_ingreso =  materia_prima_e_insumos.id_tipo_ingreso 
					INNER JOIN  tipo_materia_prima_e_insumos ON tipo_materia_prima_e_insumos.id_azas_ins = materia_prima_e_insumos.id_azas_ins 
					INNER JOIN  unidad ON unidad.id_unidad = materia_prima_e_insumos.id_unidad
					INNER JOIN  registro_usuario ON registro_usuario.id_usuario = materia_prima_e_insumos.id_usuario 
					INNER JOIN  unidad_de_medida ON unidad_de_medida.id_unidad_medida =  materia_prima_e_insumos.id_unidad_medida;
					$where 
					";
			// echo $query; exit;	
